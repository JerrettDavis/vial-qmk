...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ansi( /* FN */
		EE_CLR,  KC_BRID, KC_BRIU, A(KC_TAB),G(KC_D),KC_RETN, KC_WSCH, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,
		_______, KC_BT1,  KC_BT2,  KC_BT3,  KC_2G4,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		...
		_______, _______, RGB_TOG, RGB_MOD, RGB_HUI, _______, _______, _______, _______, _______, KC_PAUS, _______, _______, RGB_VAI, _______,
